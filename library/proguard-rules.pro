...
-keep public class * implements com.ieemoo.libary.integration.ConfigModule

 #实体类不参与混淆
-keep class com.ieemoo.libary.widget.** { *; } #自定义控件不参与混淆
...
-keep class com.alipay.android.app.IAlixPay{*;}
-keep public class com.elvishew.xlog.**